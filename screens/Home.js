...
export default class Home extends React.Component {
    ...
    getPhotos = () => {
        ...
        if (this.props.screenProps.user) {
            if(this.props.screenProps.tabLabel == 'photos'){
                request = `${API_ENDPOINT}users/${this.props.screenProps.user.username}/photos?page=${this.state.page};per_page=50;${CLIENT_ID}`
            } else {
                request = `${API_ENDPOINT}users/${this.props.screenProps.user.username}/likes?page=${this.state.page};per_page=50;${CLIENT_ID}`
            }
        } else {
            request = `${API_ENDPOINT}photos?page=${this.state.page};per_page=50;${CLIENT_ID}`;
        }
    ...
    searchPhotos = (text) => {
        ...
        fetch(`${API_ENDPOINT}search/photos?page=${this.state.page};query=${text};per_page=50;${CLIENT_ID}`)
        .then((response) => {  
            response.json().then((responseJson) => {
                this.setState({
